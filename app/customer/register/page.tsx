...
import { User, Mail, Lock, Phone, MapPin, Building, IdCard, Upload, Check, ArrowRight, ArrowLeft } from 'lucide-react';
        ...
        <div className="min-h-screen bg-gradient-to-br from-blue-50 to-blue-100 flex items-center justify-center p-4 py-12 relative overflow-hidden">
            ...
            <div className="w-full max-w-2xl bg-white/90 backdrop-blur-xl rounded-2xl shadow-2xl border border-white/50 p-8 sm:p-12 relative z-10">
                <div className="mb-10 text-center">
                    ...
                    <p className="text-gray-500 max-w-md mx-auto">Create an account to browse and rent premium agriculture equipment.</p>
                </div>
                ...
                <form className="space-y-8">
                            ...
                            <div className="grid md:grid-cols-2 gap-6">
                                <div className="group md:col-span-2">
                                    ...
                                    <div className="relative">
                                        ...
                                        <input type="text" placeholder="John Doe" className="w-full pl-10 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all outline-none" required />
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="grid md:grid-cols-2 gap-6">
                                <div className="group">
                                    ...
                                    <div className="relative">
                                        ...
                                        <input type="email" placeholder="john@example.com" className="w-full pl-10 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all outline-none" required />
                                    </div>
                                </div>
                                <div className="group">
                                    ...
                                    <div className="relative">
                                        ...
                                        <input type="tel" maxLength={10} placeholder="9876543210" className="w-full pl-10 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all outline-none" required />
                                    </div>
                                </div>
                                <div className="group md:col-span-2">
                                    ...
                                    <div className="relative">
                                        ...
                                        <input type="password" placeholder="••••••••••••" className="w-full pl-10 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all outline-none" required />
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="grid md:grid-cols-2 gap-6">
                                <div className="group md:col-span-2">
                                    ...
                                    <div className="relative">
                                        ...
                                        <textarea rows={2} placeholder="House No, Street, Area..." className="w-full pl-10 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all outline-none resize-none" required></textarea>
                                    </div>
                                </div>
                                <div className="group">
                                    ...
                                    <div className="relative">
                                        ...
                                        <input type="text" placeholder="Indore" className="w-full pl-10 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all outline-none" required />
                                    </div>
                                </div>
                                <div className="group">
                                    <label className="block text-sm font-medium text-gray-700 mb-1.5 ml-1">ID Proof Upload</label>
                                    <div className="relative border-2 border-dashed border-gray-300 rounded-xl p-4 transition-colors hover:border-blue-400 group-hover:bg-blue-50/30 cursor-pointer flex flex-col items-center justify-center gap-2 text-center h-[52px] !py-0 !pl-0 !pr-0">
                    ...
                    <div className="flex items-start space-x-3 pt-4">
                        <div className="relative flex items-center h-5">
                            <input type="checkbox" className="w-4 h-4 rounded border-gray-300 text-blue-600 focus:ring-blue-500 transition-colors" required />
                        </div>
                        <div className="text-sm">
                            <span className="text-gray-500">I agree to the </span>
                            <a href="#" className="font-medium text-blue-600 hover:text-blue-500 underline decoration-blue-200 underline-offset-2">Terms & Conditions</a>
                            <span className="text-gray-500"> and Privacy Policy.</span>
                        </div>
                    </div>

                    <div className="pt-2">
                        <Link href="/" className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-4 rounded-xl shadow-lg hover:shadow-blue-500/30 transition-all transform hover:-translate-y-0.5 active:translate-y-0 flex items-center justify-center space-x-2 group">
                ...
                <div className="mt-8 pt-6 border-t border-gray-100 text-center">
                    <p className="text-sm text-gray-500">
                        ...
                        <Link href="/customer/login" className="font-semibold text-blue-600 hover:text-blue-700 transition-colors inline-flex items-center gap-1 group">
